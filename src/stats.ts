...
declare const Chart: any;                // global Chart symbol
...
async function drawMonthlyGoalsBars(): Promise<void> {
  ...
  new Chart(
    document.getElementById("hits-chart") as HTMLCanvasElement,  // reuse canvas
    {
      type:"bar",
      data:{
        labels,
