...
const main = game === null || game === void 0 ? void 0 : game.parentElement; // the <main> element
...
if (game && main) {
    ...
    /* Home → show WSec */
    const homeBtn = document.querySelector('button[data-nav="home"]');
    ...
    (_a = document.getElementById("WSec-play")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => {
        var _a;
        (_a = document.getElementById("nav-play")) === null || _a === void 0 ? void 0 : _a.click();
    });
    (_b = document.getElementById("WSec-profile")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => {
        var _a;
        (_a = document.getElementById("nav-profile")) === null || _a === void 0 ? void 0 : _a.click();
    });
